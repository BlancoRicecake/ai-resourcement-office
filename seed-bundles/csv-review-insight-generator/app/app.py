...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  textarea { width: 100%; min-height: 180px; font-family: Consolas, monospace;
             font-size: 0.85rem; border-radius: 8px; border: 1px solid #8886; padding: 10px; }
  input[type=text] { width: 100%; border-radius: 8px; border: 1px solid #8886; padding: 8px 10px; }
...
def run_cli(argv):
    ...
    if output_path:
        Path(output_path).write_text(result["report_markdown"] + "\n", encoding="utf-8")
