> **⚠️ 이 템플릿은 v0.1(Python 미니 SaaS 전제)이며, 정본
> `agent-factory/template/`(v0.2 폴더-번들 스켈레톤)로 대체되었습니다.**
> 새 번들은 `agent-factory/template/`을 복제해서 시작하세요. 이 폴더의
> 나머지 파일은 참고용으로 남겨두며 삭제하지 않습니다.
